...
const Nav = (() => {
  ...
  // continuity is obvious when readers click through to the company site.
  ...
  // The footer "Visit NICE SPACESHIP" link uses the new constellation mark.
  // The nav-brand stays text-only ("BEN DUFFEY") — Ben's name is the lockup.
